...
### Done
- `plugins/fluid_domain_visibility.py` — addon code, tested live in Blender 4.2.5
...
- `plugins/fluid_domain_visibility/README.md` — user-facing docs
- `plugins/fluid_domain_visibility/listing.md` — marketplace copy (short + long description, tags)
- `plugins/fluid_domain_visibility/announce.md` — announcement copy (Twitter, BlenderArtists/Reddit, newsletter)
