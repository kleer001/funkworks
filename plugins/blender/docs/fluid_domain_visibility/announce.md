...
Every fluid sim setup has the same tedious step: keyframe the domain hidden one frame before the sim starts, visible on the start frame. It takes about 30 seconds but you do it every single time.
